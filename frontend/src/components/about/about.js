...
const About = (props) => {
  ...
  root.style.backgroundImage = `url(./backgrounds/about.jpg)`;
          ...
          <ul className="about-sub-ul">
            ...
            <ul className="about-links-ul">
              ...
              <li>
                <a target="_blank"
                  rel="noreferrer"
                  href="http://github.com/dackroydisales">
          ...
          <ul className="about-sub-ul">
            ...
            <ul className="about-links-ul">
              ...
              <li>
                <a target="_blank"
                  rel="noreferrer"
                  href="https://github.com/jmcbgaston">
                  <GitHubIcon className="about-icon" />
                </a>
              </li>
            </ul>
          ...
          <ul className="about-sub-ul">
            ...
            <ul className="about-links-ul">
              <li>
                <a target="_blank"
                  rel="noreferrer"
                  href="https://www.linkedin.com/in/alvin-chong-4b88011a1/">
                  <LinkedInIcon className="about-icon" />
                </a>
              </li>
              <li>
                <a target="_blank"
                  rel="noreferrer"
                  href="https://github.com/alvinc90">
                  <GitHubIcon className="about-icon" />
                </a>
              </li>
            </ul>
